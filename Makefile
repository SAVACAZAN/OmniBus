...
$(BUILD_DIR)/omnibus_network_os.o: ./modules/omnibus_network_os/network_layer.zig ./modules/omnibus_network_os/peer_management.zig ./modules/omnibus_network_os/gossip.zig ./modules/omnibus_network_os/packet_validator.zig | $(BUILD_DIR)/.keep
	@echo "[ZIG] Compiling OmniBus Network OS to object file..."
	cd ./modules/omnibus_network_os && zig build-obj network_layer.zig -target x86_64-freestanding -O ReleaseFast -ofmt=elf 2>&1 | grep -v "note:" || true
	@if [ -f ./modules/omnibus_network_os/network_layer.o ]; then cp ./modules/omnibus_network_os/network_layer.o $(BUILD_DIR)/omnibus_network_os.o; fi

$(BUILD_DIR)/omnibus_network_os_stubs.o: ./modules/omnibus_network_os/libc_stubs.asm | $(BUILD_DIR)/.keep
	@echo "[AS] Assembling OmniBus Network OS libc stubs..."
	nasm -f elf64 -o $@ $<

$(BUILD_DIR)/omnibus_network_os.elf: $(BUILD_DIR)/omnibus_network_os.o $(BUILD_DIR)/omnibus_network_os_stubs.o ./modules/omnibus_network_os/omnibus_network_os.ld
	@echo "[LD] Linking OmniBus Network OS ELF..."
	ld -T ./modules/omnibus_network_os/omnibus_network_os.ld -o $@ $(BUILD_DIR)/omnibus_network_os.o $(BUILD_DIR)/omnibus_network_os_stubs.o 2>&1 | grep -v "warning:" || true
...
$(BUILD_DIR)/lightweight_miner_os.o: ./modules/lightweight_miner_os/lightweight_miner_os.zig | $(BUILD_DIR)/.keep
	@echo "[ZIG] Compiling Lightweight Miner OS to object file..."
	cd ./modules/lightweight_miner_os && zig build-obj lightweight_miner_os.zig -target x86_64-freestanding -O ReleaseFast -ofmt=elf 2>&1 | grep -v "note:" || true
	@if [ -f ./modules/lightweight_miner_os/lightweight_miner_os.o ]; then cp ./modules/lightweight_miner_os/lightweight_miner_os.o $(BUILD_DIR)/lightweight_miner_os.o; fi

$(BUILD_DIR)/lightweight_miner_os_stubs.o: ./modules/lightweight_miner_os/libc_stubs.asm | $(BUILD_DIR)/.keep
	@echo "[AS] Assembling Lightweight Miner OS libc stubs..."
	nasm -f elf64 -o $@ $<

$(BUILD_DIR)/lightweight_miner_os.elf: $(BUILD_DIR)/lightweight_miner_os.o $(BUILD_DIR)/lightweight_miner_os_stubs.o ./modules/lightweight_miner_os/lightweight_miner_os.ld
	@echo "[LD] Linking Lightweight Miner OS ELF..."
	ld -T ./modules/lightweight_miner_os/lightweight_miner_os.ld -o $@ $(BUILD_DIR)/lightweight_miner_os.o $(BUILD_DIR)/lightweight_miner_os_stubs.o 2>&1 | grep -v "warning:" || true
...
$(BUILD_DIR)/wallet_state.o: ./modules/bot_strategies/wallet_state.zig | $(BUILD_DIR)/.keep
	@echo "[ZIG] Compiling Wallet State to object file..."
	cd ./modules/bot_strategies && zig build-obj wallet_state.zig -target x86_64-freestanding -O ReleaseFast -ofmt=elf 2>&1 | grep -v "note:" || true
	@if [ -f ./modules/bot_strategies/wallet_state.o ]; then mv ./modules/bot_strategies/wallet_state.o $@; fi

$(BUILD_DIR)/user_accounts.o: ./modules/bot_strategies/user_accounts.zig | $(BUILD_DIR)/.keep
	@echo "[ZIG] Compiling User Accounts to object file..."
	cd ./modules/bot_strategies && zig build-obj user_accounts.zig -target x86_64-freestanding -O ReleaseFast -ofmt=elf 2>&1 | grep -v "note:" || true
	@if [ -f ./modules/bot_strategies/user_accounts.o ]; then mv ./modules/bot_strategies/user_accounts.o $@; fi

$(BUILD_DIR)/local_exchange.o: ./modules/bot_strategies/local_exchange.zig | $(BUILD_DIR)/.keep
	@echo "[ZIG] Compiling Local Exchange to object file..."
	cd ./modules/bot_strategies && zig build-obj local_exchange.zig -target x86_64-freestanding -O ReleaseFast -ofmt=elf 2>&1 | grep -v "note:" || true
	@if [ -f ./modules/bot_strategies/local_exchange.o ]; then mv ./modules/bot_strategies/local_exchange.o $@; fi
...
$(BUILD_DIR)/rpc_state_os.elf: $(BUILD_DIR)/rpc_state_os.o $(BUILD_DIR)/rpc_state_os_stubs.o ./modules/rpc_state_os/rpc_state_os.ld
	@echo "[LD] Linking RPC State OS ELF..."
	ld -T ./modules/rpc_state_os/rpc_state_os.ld -o $@ $(BUILD_DIR)/rpc_state_os.o $(BUILD_DIR)/rpc_state_os_stubs.o 2>&1 | grep -v "warning:" || true
...
# ============================================================================
# Phase 66: Status Token OS (Monetization System)
# ============================================================================
...
$(BUILD_DIR)/status_token_os_stubs.o: modules/status_token_os/libc_stubs.asm
	...
	nasm -f elf64 -o $@ $< 2>/dev/null || echo "  (stubs optional)"

$(BUILD_DIR)/status_token_os.elf: $(BUILD_DIR)/status_token_os.o ./modules/status_token_os/status_token_os.ld
	@echo "[LD] Linking Status Token OS ELF..."
	ld -T ./modules/status_token_os/status_token_os.ld -o $@ $(BUILD_DIR)/status_token_os.o 2>&1 | grep -v "warning:" || true
...
$(BUILD_DIR)/on_ramp_os.elf: $(BUILD_DIR)/on_ramp_os.o ./modules/on_ramp_os/on_ramp_os.ld
	...
	ld -T ./modules/on_ramp_os/on_ramp_os.ld -o $@ $(BUILD_DIR)/on_ramp_os.o 2>&1 | grep -v "warning:" || true
...
$(BUILD_DIR)/staking_boost_os.elf: $(BUILD_DIR)/staking_boost_os.o ./modules/staking_boost_os/staking_boost_os.ld
	...
	ld -T ./modules/staking_boost_os/staking_boost_os.ld -o $@ $(BUILD_DIR)/staking_boost_os.o 2>&1 | grep -v "warning:" || true
