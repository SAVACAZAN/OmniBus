...
# Genesis and Faucet OS (0x660000, 64KB) — Phase 61
# Blockchain initialization, genesis block, OMNI token distribution, and faucet
$(BUILD_DIR)/genesis_and_faucet.o: ./modules/genesis_and_faucet/genesis_and_faucet.zig | $(BUILD_DIR)/.keep
	@echo "[ZIG] Compiling Genesis and Faucet OS to object file..."
	cd ./modules/genesis_and_faucet && zig build-obj genesis_and_faucet.zig -target x86_64-freestanding -O ReleaseFast -ofmt=elf 2>&1 | grep -v "note:" || true
	@if [ -f ./modules/genesis_and_faucet/genesis_and_faucet.o ]; then cp ./modules/genesis_and_faucet/genesis_and_faucet.o $(BUILD_DIR)/genesis_and_faucet.o; fi

$(BUILD_DIR)/genesis_and_faucet_stubs.o: ./modules/genesis_and_faucet/libc_stubs.asm | $(BUILD_DIR)/.keep
	@echo "[AS] Assembling Genesis and Faucet OS libc stubs..."
	nasm -f elf64 -o $@ $<

$(BUILD_DIR)/genesis_and_faucet.elf: $(BUILD_DIR)/genesis_and_faucet.o $(BUILD_DIR)/genesis_and_faucet_stubs.o ./modules/genesis_and_faucet/genesis_and_faucet.ld
	@echo "[LD] Linking Genesis and Faucet OS ELF..."
	ld -T ./modules/genesis_and_faucet/genesis_and_faucet.ld -o $@ $(BUILD_DIR)/genesis_and_faucet.o $(BUILD_DIR)/genesis_and_faucet_stubs.o 2>&1 | grep -v "warning:" || true

$(BUILD_DIR)/genesis_and_faucet.bin: $(BUILD_DIR)/genesis_and_faucet.elf
	@echo "[OC] Converting Genesis and Faucet OS to binary..."
	objcopy -O binary $< $@
	@echo "  Genesis and Faucet OS binary: $@ (size: $$(stat -c%s $@) bytes)"
