...
const EXPECTED_ADDRESSES = struct {
    // Classical chains
    ...
    // Post-quantum domains (from deterministic derivation)
    love: [*:0]const u8 = "ob_k1_3a4b5c6d7e8f9a0b1c2d3e4f5a6b7c8d",
    food: [*:0]const u8 = "ob_f5_7e8f0a1b2c3d4e5f6a7b8c9d0e1f2a3b",
    rent: [*:0]const u8 = "ob_d5_2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f",
    vacation: [*:0]const u8 = "ob_s3_9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c",
};
